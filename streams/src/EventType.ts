...
export interface StreamItem<ItemType = any> {
    t: EventType.c_item;
    item: ItemType;
}
...
export interface StreamSchema {
    t: EventType.c_schema;
    schema: SchemaDecl;
}
export interface StreamRestart {
    t: EventType.c_restart;
}
...
export type StreamEvent<ItemType = any> = StreamSchema | StreamItem<ItemType> | StreamFail | StreamLogInfo | StreamLogWarn | StreamLogError | StreamDone | StreamRestart | StreamDelta;
