...
import { t_ident, t_unrecognized, t_space, t_double_dash, t_line_comment, t_block_comment, t_quoted_string, t_double_equals, t_double_bar, t_double_amp, t_gthaneq, t_lthaneq, t_right_arrow, t_right_fat_arrow, tokenFromSingleCharCode, t_triple_equals, t_bang_equals, t_bang_double_equals, t_integer } from './tokens';
